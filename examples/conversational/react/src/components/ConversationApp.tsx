...
import { ConversationManager, ConversationState } from '../lib/ConversationManager';
...
export const ConversationApp: React.FC = () => {
  ...
  const handleUrlChange = (newUrl: string) => {
    if (conversationManagerRef.current && !conversationManagerRef.current.isActive()) {
      try {
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <input
            ...
            style={{
              ...
              borderRadius: '8px',
              fontSize: '14px',
              backgroundColor: conversationState.isConnected ? '#f9fafb' : 'white',
            }}
        ...
        <div style={{
          ...
          {conversationState.isRecording && (
            <div style={{
              ...
              Audio Level: {(conversationState.currentAmplitude * 100).toFixed(1)}%
            </div>
          )}
        </div>
