...
Examples:
  ...
  python -m scripts.setup-env DEEPGRAM_API_KEY
    ...
    parser.add_argument(
        'keys',
        nargs='*',
        help='Environment variable keys to set up (e.g., DEEPGRAM_API_KEY OPENAI_API_KEY)'
    )
    
    parser.add_argument(
        '--env-file',
        type=str,
        help='Path to .env file (default: auto-detect or create .env in current directory)'
    )
    
    parser.add_argument(
        '--list-common',
        action='store_true',
        help='List common environment variables for AuStack'
    )
